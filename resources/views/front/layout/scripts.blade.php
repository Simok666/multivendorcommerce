    ...
    $(document).ready(function() {
        ...
        function updateShipping() {
            ...
            $.ajax({
                ...
                method : 'GET',
                data   : {
                    destination: selectedAddress.val(), courier: courier
                },
                success: function(data) {
                    ...
                    $('#result-courier').empty();
                                ...
                                $(this).on('change', function() {
                                    ...
                                    if ($(this).is(':checked')) {
                                        ...
                                        var shippingCharges = parseFloat($(this).attr('shipping_charges'));
                                    
                                        
                                        var grand_total = parseFloat($('#price_static').val());
                                        ...
                                        document.getElementById('shipping_charges').value = shippingCharges;
                                    }
                                });
                            });
                },
